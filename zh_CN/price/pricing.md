...
<table>
   ...
   <tr>
      <td>专业版</td>
      <td>支持按量抵扣的计费模式。提供不同 VUM 规格的测试包供选购，根据测试实际消耗的 VUM 从测试包按量抵扣。查看 <a href="#测试包定价详情及计费规则">测试包定价详情及计费规则</a></td>
      <td>支持按量抵扣、后付费两种计费模式。提供不同流量规格的流量包供选购，根据测试实际消耗的公网流量从流量包按量抵扣。或以￥1.50/GB 的后付费价格从余额中抵扣。升级专业版赠送 1GB 流量包。查看 <a href="#流量包定价详情及计费规则">流量包定价详情及计费规则</a></td>
   </tr>
</table>
